...
export const CROPS = [
  ...
  { name: "Beans", icon: "\uD83E\uDEDB", frostThreshold: 3, heatThreshold: 32, gddBase: 8 },
  ...
  { name: "Cabbages", icon: "\uD83E\uDD6C", frostThreshold: 1, heatThreshold: 28, gddBase: 5 },
  { name: "SukumaWiki", icon: "\uD83E\uDD6C", frostThreshold: 2, heatThreshold: 30, gddBase: 6 },
  { name: "Spinach", icon: "\uD83E\uDD57", frostThreshold: 1, heatThreshold: 27, gddBase: 4 },
  { name: "Onions", icon: "\uD83E\uDDC5", frostThreshold: 0, heatThreshold: 33, gddBase: 7 },
  { name: "Watermelons", icon: "\uD83C\uDF49", frostThreshold: 10, heatThreshold: 38, gddBase: 12 },
